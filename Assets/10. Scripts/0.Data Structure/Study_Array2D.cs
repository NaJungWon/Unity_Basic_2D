...
namespace Study_DataStructure
{
    public class Study_Array2D : MonoBehaviour
    {
        ...
        public void Array2D()
        {
            ...
            // 다른 언어의 new "int[3][3]"이 아님을 유의
            // 1-1 크기만 지정하고 나중에 값 할당
            int[,] gameBoard = new int[3, 3]; //=> 3x3크기의 바둑판이 생김. 초기값 = 0
            ...
            Debug.Log($"gameBoar의 [0,0] 값 : {gameBoard[0, 0]}"); //0출력됨
            Debug.Log("");
