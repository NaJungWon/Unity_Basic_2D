...
namespace Study_ActionPlatformer
{
    ...
    // [책임 분리]
    // - PlayerController      : "무엇을 할지 결정하는 클래스입니다.
    //                          입력을 일고, 상태를 갈아끼우고, 공용 동작을 제공합니다.
    // - CharacterController2D : "어떻게 움직일지"를 결정하는 클래스입니다.
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        // = static readonly : 상수처럼 다루고 싶어서 사용하는 키워드입니다.
        ...
        private void UpdateAnimState()
        {
            ...
            // # AnimatorStateInfo?
            // - Animator 의 상태 정보를 담고 있는 구조체 입니다.
            ...
            {
                // 검색해서 없으면 next State = defaultState처리
