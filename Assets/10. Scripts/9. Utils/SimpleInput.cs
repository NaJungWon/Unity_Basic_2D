...
namespace Study.Utilities
{
    ...
    // SinpleInput 클래스는 어디서든 호출할 수 있게
    // static(정적, 고정된, 랜드마크) 키워드를 사용하여 선언합니다
    public static class SimpleInput
    {
        ...
        /// A/D키 또는 좌/우 화살표 키 대응. 
        /// (레거시에서 Input.GetAxisRaw("Horizontal")과 동일합니다.
        /// </summary>
        /// <returns></returns>
        public static float GetAxishHorizontalRaw()
        {
            float axis = 0.0f;
        ...
        /// W/S키 또는 위/아래 화살표 키 대응. 
        /// (레거시에서 Input.GetAxisRaw("Vertical")과 동일합니다.
        /// </summary>
        /// <returns></returns>
        public static float GetAxishVerticalRaw()
        {
            float axis = 0.0f;
        ...
        public static Vector2 GetMoveAxisRaw()
        {
            ...
            axis.x = GetAxishHorizontalRaw();
            axis.y = GetAxishVerticalRaw();
