...
namespace Study_Mono
{
    ...
    public class Study_MonoBehaviour : MonoBehaviour
    {
        ...
        //public 접근 제한자를 사용하면 인스펙터에 노출됩니다.
        ...
        private void Update()
        {
            ...
            {
                Triangle.transform.position = Triangle.transform.position + (Vector3.up * speed * Time.deltaTime);
                //waitTime = 0;
            }
        }

        // FixedUpdate() : 고정된 시간 간격(Fixed Timstep)마다 호출됨
        private void FixedUpdate()
        {
            //Debug.Log("FixedUpdate()가 호출 되었습니다");
        }

        // LateUpdate() : 모든 Mono의 Update가 종료된 후에 호출됨
